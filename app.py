...
def verifyAndRenderRespective():
	...
	try:
		...
		elif username == 'deepak' and password == 'deepak':

			res = runQuery('call delete_old()')
			return render_template('manager.html')
		
		elif username == 'daksh' and password == 'daksh':
...
# 	os.environ['PYTHONDONTWRITEBYTECODE'] = '1'
# 	app.debug = True
# 	# url="http://172.18.43.72:"+str(5000)+"/"
# 	# webbrowser.open_new(url)
# 	app.run(host="172.18.43.72",port=5000)
# 	# app.run(host="192.168.43.196",port=5000)
# 	# app.run()
